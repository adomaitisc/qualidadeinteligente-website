...
function Form() {
  return (
    <form className={s5.formClass}>
      ...
      <label htmlFor={s5.form.input2.id}>{s5.form.input2.label}</label>
      <input type={s5.form.input2.type} id={s5.form.input2.id} />
      <label htmlFor={s5.form.input3.id}>{s5.form.input3.label}</label>
      <input type={s5.form.input3.type} id={s5.form.input3.id} />
      <label htmlFor={s5.form.input4.id}>{s5.form.input4.label}</label>
      <input type={s5.form.input4.type} id={s5.form.input4.id} />
      <label htmlFor={s5.form.input5.id}>{s5.form.input5.label}</label>
      <input type={s5.form.input5.type} id={s5.form.input5.id} />
      <label htmlFor={s5.form.input6.id}>{s5.form.input6.label}</label>
      <input type={s5.form.input6.type} id={s5.form.input6.id} />
      <label htmlFor={s5.form.input7.id}>{s5.form.input7.label}</label>
